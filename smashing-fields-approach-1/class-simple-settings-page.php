...
class Simple_Settings_Page {
    ...
    /**
     * Plugin version, useful for cache-busting of script (JS) & style (CSS) file references.
     * 
     * @var String
     */
    private $version;
    ...
    /**
     * Unique identifier for the plugin. May also used as text domain if the site undergoes internationalization to accommodate more than 1 language (see https://developer.wordpress.org/themes/functionality/internationalization/).
     * 
     * @var String
     *
     * @since 0.1.0 
    ...
    public function create_plugin_settings_page() {
        ...
        $page_title = 'Firefly Demo Settings Page';
        $menu_title = 'Firefly Demo';
    ...
    public function plugin_settings_page_content() { ?>
    	<div class="wrap">
    		<h2>Settings Page for Firefly Demo</h2>
    ...
    public function setup_sections() {
        add_settings_section( 'section_1', '', array( $this, 'section_callback' ), $this->slug );
    }

    public function section_callback( $arguments ) {
    	if( $arguments['id'] == 'section_1' ){
